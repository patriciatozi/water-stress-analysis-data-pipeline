...
Esta primeira versão implementa somente a camada **Bronze** do MVP:
...
Sentinel-2, MapBiomas, SoilGrids, INMET, transformações Silver e produtos analíticos não fazem parte desta versão.
...
Executar as duas fontes, respeitando a dependência IBGE → NASA POWER:
